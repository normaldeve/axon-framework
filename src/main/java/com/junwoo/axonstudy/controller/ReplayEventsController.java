...
public class ReplayEventsController {
    ...
    private final StreamableMessageSource streamableMessageSource;
    ...
    @Parameters({
            ...
            @Parameter(name = "startDateTime", in = ParameterIn.PATH, description = "시작일시(생략 시 모든 Event Replay)", allowEmptyValue = true, example = "2026-01-05T00:00:00.00Z")
    })
    String replayEventFor(
        ...
        configuration.eventProcessingConfiguration().eventProcessorByProcessingGroup(processingGroupName, StreamingEventProcessor.class)
